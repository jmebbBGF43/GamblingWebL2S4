        ...
        <?php foreach ($faqs as $faq): ?>
            <tr class="border-b border-default">
                ...
                <td class="px-6 py-4 flex gap-2">
                    <a href="/~uapv2500805/admin/Controller/controller_adminfaq.php?action_faq=toggle&id=<?= $faq['id'] ?>" class="p-2 bg-yellow-600 rounded text-center hover:opacity-80">
                        <?= $faq['is_active'] ? 'Masquer' : 'Afficher' ?>
                    </a>
                    <a href="/~uapv2500805/admin/Controller/controller_adminfaq.php?action_faq=delete&id=<?= $faq['id'] ?>" onclick="return confirm('Supprimer définitivement ?');" class="p-2 bg-red-600 rounded text-center hover:opacity-80">
                        Supprimer
                    </a>
                </td>
            </tr>
...
<div class="bg-[#355872] rounded-xl p-8 w-full max-w-2xl mx-auto">
    ...
    <form method="POST" action="/~uapv2500805/admin/Controller/controller_adminfaq.php?action_faq=store" class="flex flex-col gap-4">
