<div class="max-w-2xl mx-auto p-8 bg-[#1a2c38] rounded border border-white/10 shadow-2xl">
    ...
    <div class="mt-10 flex flex-col gap-3">
        <a href="<?= BASE_URL ?>Controller/controller_menu.php?user_pageID=parameter" class="block w-full py-3 text-center bg-[#1576e2] hover:bg-blue-600 text-white font-bold rounded">
